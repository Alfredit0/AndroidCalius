        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                if(isNetDisponible() && isOnlineNet()){
                    ...
                    //Convertir la matricula, contraseña y contraseña de comunicacion a json
                    JSONObject obj1 = new JSONObject();
                    try {
                        obj1.put("passcon", "12345");
                        obj1.put("iduser", mEmail);
                        obj1.put("password", mPassword);
                    ...
                    //comprobar el usuario y contraseña envianadolo al servicio web
