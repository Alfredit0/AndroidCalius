...
public class GcmRegistratation extends AppCompatActivity {
    ...
    String idUser, passCon;

    public GcmRegistratation(Context contextoAct, String idUserAct, String passConAct){
        Log.e("Alerta","Instanciando la clase de Registro");
    this.contexto = contextoAct;
        this.idUser = idUserAct;
        this.passCon = passConAct;
    }
    ...
    private SharedPreferences getPreferenciasCompartidas() {
        return getSharedPreferences(actividadInicio.class.getSimpleName(),
    ...
    private void enviarIdentificadorRegistroALaAplicacionJ2ee()
        ...
        requestRegistrationId.put("passcon", passCon);
        requestRegistrationId.put("iduser", idUser);
